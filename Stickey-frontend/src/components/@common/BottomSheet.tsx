...
const BottomSheet: React.FC<Props> = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      <div className={`relative z-[2] w-full h-screen top-0 pb-16 left-0 right-0 transition ease-in-out delay-200 ${isRendering ? "bg-black/50" : "bg-black/0"}`} onClick={onClose} ></div>
      <div className="fixed w-[360px] bottom-12 max-h-52 bg-white p-4 rounded-t-[20px] z-[3]">
        <div className="flex flex-col items-center">
          <div>
            <img src="src/assets/@common/Line.png" className="w-9" />
          </div>
          ...
          <div className="flex flex-row justify-center gap-4 ">
            <div className="flex flex-col items-center justify-center w-[88px] h-[100px] border border-Stickey_Gray rounded-[5px] gap-1 cursor-pointer" onClick={() => navigate("/soccer")} >
              <img src="src/assets/Category/soccerball.png" className="w-[50px] scale-[1.6]" />
            ...
            >
              <img src="src/assets/Category/baseball.png" className="w-[50px]" />
            ...
            >
              <img src="src/assets/Category/basketball.png" className="w-[50px]" />
