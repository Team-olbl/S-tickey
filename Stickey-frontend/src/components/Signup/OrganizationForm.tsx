        ...
        <>
          ...
          <div className="fixed bottom-20 w-full max-w-[500px] m-auto px-4">
            <button
              ...
              className={`bg-Stickey_Main w-full text-white rounded-md p-2 text-md ${!isFormValid() ? 'opacity-50 cursor-not-allowed' : ''}`}
          ...
          <div className="px-4 pt-4">
            ...
            <div className="flex flex-row items-center">
              <input
                ...
                readOnly
              />
              <button className="bg-blue-400 w-32 text-white py-2 px-2 rounded" onClick={() => setIsPostcodeOpen(true)}>
                주소 검색
              </button>
            </div>
            {isPostcodeOpen && (
          ...
          <form onSubmit={handleSubmit}>
            <div className="fixed bottom-20 w-full max-w-[500px] m-auto px-4">
              <button
                ...
                className={`bg-Stickey_Main w-full text-white rounded-md p-2 text-md ${!isSignupValid() ? 'opacity-50 cursor-not-allowed' : ''}`}
                onClick={() => handleFormState()}
              >
                가입하기
              </button>
