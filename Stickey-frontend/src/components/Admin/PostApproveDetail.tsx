    ...
    <Modal width="80vw" height="" title="" onClose={onClose}>
      <div className="flex flex-col items-center pb-4 overflow-y-scroll gap-5 h-[50vh]">
        ...
        <div className="flex gap-5">
          <button className="w-20 text-xs text-white bg-Stickey_Main rounded-md p-1" onClick={handleApprove}>
            승인
          </button>
          <button className="w-20 text-xs text-white bg-Stickey_Main rounded-md p-1" onClick={handleReject}>
            거절
          </button>
        </div>
      </div>
