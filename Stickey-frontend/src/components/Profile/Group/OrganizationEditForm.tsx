      ...
      <div className="pt-16 text-sm">
        <div className="px-4 pb-28">
          ...
          <div>
            ...
            <input type="text" placeholder="삼성" className="w-full outline-none border-b p-2 text-xs" />
            <p className="pt-4 pb-2 text-sm">연락처</p>
            <input type="text" placeholder="010-1234-5678" className="w-full outline-none border-b p-2 text-xs" />
            ...
            <input type="text" placeholder="김스티키" className="w-full outline-none border-b p-2 text-xs" />
            <p className="pt-4 pb-2 text-sm">주소</p>
            <input type="text" placeholder="구미시 인동2길 14-3" className="w-full outline-none border-b p-2 text-xs" />
            <p className="pt-4 pb-2 text-sm">사업자 등록번호</p>
            <input type="text" placeholder="123-1234-1234" className="w-full outline-none border-b p-2 text-xs" />
            <div className="flex flex-row items-center pt-4 pb-2">
              <p className=" text-sm">파일 첨부</p>
              <img className="p-2 cursor-pointer" src={Folder} onClick={() => fileRef.current?.click()} />
            </div>
            <div className="flex items-center">
              {fileName && (
                <div className="flex items-center mr-4">
                  <span className="mr-2">{fileName}</span>
                  <button onClick={clearFile} className="text-red-500 focus:outline-none">
                    삭제
                  </button>
                </div>
              )}
