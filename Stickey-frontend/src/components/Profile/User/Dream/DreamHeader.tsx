    ...
    <>
      <div className="flex flex-row justify-center w-full h-[48px] gap-5 ">
        <div className="relative flex items-center gap-2">
          <div>
            <div className="relative w-5 border-b border-[#8989FF] "></div>
            <div className="absolute w-2 h-[8px] rounded-full bg-[#8989FF] left-[6px] top-1/2 transform -translate-y-1/2"></div>
          </div>
