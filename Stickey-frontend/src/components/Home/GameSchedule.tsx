  ...
  return (
    <div className="w-full min-h-[232px] p-[12px]">
      <div className="flex flex-row items-center mb-[10px]">
        <img src={대구FC} alt="..." className="w-[28px] h-[28px]"/>
        <img src={FC서울} alt="..." className="w-[28px] h-[28px]"/>
