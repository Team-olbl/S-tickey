...
export const setFilterOnTicket = async (tokenId: number, itemId: number, supportId: number) => {
  ...
  try {
    const ret = await contract.methods
      .setFilterOnTicket(tokenId, itemId, supportId)
      .send({ from: account, gasPrice: 3000000 });
    return ret;
  } catch (err) {
    console.log(err);
  }
...
export const setBackgroundOnTicket = async (tokenId: number, itemId: number, supportId: number) => {
  ...
  try {
    const ret = await contract.methods
      .setBackgroundOnTicket(tokenId, itemId, supportId)
      .send({ from: account, gasPrice: 3000000 });
    return ret;
  } catch (err) {
    console.log(err);
...
export const setGame = async (
  ...
  try {
    ...
    const ret = await contract.methods
      .setGame(id, bookStartTime, gameStartTime, stadium, homeTeam, awayTeam, cate, gameImage)
      .send({ from: account, gasPrice: 3000000 });
    return ret;
  } catch (err) {
    console.log(err);
...
export const setSeatPrice = async (stadiumId: number, zoneId: number, price: number) => {
  ...
  try {
    const ret = await contract.methods
      .setSeatPrice(stadiumId, zoneId, price)
      .send({ from: account, gasPrice: 3000000 });
    return ret;
  } catch (err) {
    console.log(err);
