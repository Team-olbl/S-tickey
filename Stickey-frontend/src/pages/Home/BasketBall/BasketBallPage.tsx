...
const BasketBallPage = () => {
  ...
  const { data: gameListInfo } = useGetGameList({ catg: 'BASKETBALL', club: selectedTeams, date: date });
  ...
  const filteredMatches = gameListInfo?.data
    ? gameListInfo.data.gameResList.filter((data: IGameSimpleRes) => {
  ...
  return (
    <>
      ...
      <div className="py-16">
        <TeamList catg="BASKETBALL" selectedTeams={selectedTeams} setSelectedTeams={setSelectedTeams} />
