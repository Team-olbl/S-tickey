          ...
          <>
            <div className="pt-20 px-4 text-center text-xs">
              ...
              <div className="pt-8 flex justify-center">
                <div
                  className={`px-6 py-2 border ${selectedType === 'individual' ? 'border-Stickey_Main' : 'border-Stickey_Gray'} rounded-2xl mx-2 cursor-pointer`}
                ...
                <div
                  className={`px-6 py-2 border ${selectedType === 'organization' ? 'border-Stickey_Main' : 'border-Stickey_Gray'} rounded-2xl mx-2 cursor-pointer`}
            ...
            <div className="fixed bottom-20 w-full max-w-[500px] m-auto px-4">
              <button
                className={`bg-Stickey_Main w-full text-white rounded-xl p-2 text-md ${selectedType ? '' : 'opacity-50 cursor-not-allowed'}`}
